...
export const update = (data) =>
  request.put(`${userPrefix}${userActivityPrefix}/admin/update`, data);
...
export const findAll = () =>
  request.get(`${userPrefix}${userActivityPrefix}/admin/find/all`);
...
export const getInteractions = () =>
  request.get(`${userPrefix}${userActivityPrefix}/public/interactions`);
