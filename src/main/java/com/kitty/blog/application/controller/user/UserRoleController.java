...
public class UserRoleController {
        ...
        public ResponseEntity<Response<Boolean>> deleteRole(@PathVariable Integer userId,
        ...
        public ResponseEntity<Response<UserRole>> save(@RequestBody UserRoleId ur) {
                ...
                return Response.createResponse(
                                ...
                                HttpStatus.OK, "保存成功",
                                HttpStatus.INTERNAL_SERVER_ERROR, "保存失败，请重试");
        }
        ...
        public ResponseEntity<Response<List<Role>>> findByUserId(@PathVariable("userId") Integer id) {
        ...
        public ResponseEntity<Response<Boolean>> exist(@PathVariable("userId") Integer userId,
