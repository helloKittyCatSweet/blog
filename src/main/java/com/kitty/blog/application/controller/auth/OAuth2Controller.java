...
public class OAuth2Controller {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "成功完成GitHub注册"),
            @ApiResponse(responseCode = "400", description = "完成GitHub注册失败，请求参数错误"),
            @ApiResponse(responseCode = "500", description = "完成GitHub注册失败，服务器内部错误")
    })
